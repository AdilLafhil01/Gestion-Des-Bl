...
<h:body>
 ...
 global  $username;
  ...
  $msg="";
   ...
   // $msg="connection non Etablie verifier vos Données";


    if(isset($_POST['connecter'])){
    $user=$_POST['username'];
    $password=$_POST['password'];
    $result=connecter($user,$password);
...
<section class="vh-100" style="background-color: #9A616D;">
        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block">
              <img src="./images/blimg.png" alt="login form" class="image-resize" style="border-radius: 1rem 0 0 1rem;width:100%;
            height: 100%;
            margin: 0 auto;" />
            </div>
 ...
 <form  method="post">
                  ...
                  <div class="form-floating mb-4 bg-warning">
                  <?php echo $msg?>
                  </div>


                  <div class="pt-1 mb-4">
                  <button type="submit" name="connecter" class="btn btn-dark btn-lg btn-block" onclick="<?seconnecter() ?>;">LOG IN</button>
